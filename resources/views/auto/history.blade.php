    ...
    <main class="md:h-screen h-full py-20 px-6">
        <div class="w-full max-w-250 mx-auto space-y-10">
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route("auto.index", ["budget" => $budget->id]) }}" class="text-butter bg-secondary px-5 py-2 font-bold rounded-2xl inline-block hover:text-secondary hover:bg-butter transition duration-700">Back to Budget</a>
            </div>
