    ...
    <main class="h-full py-10 md:py-20 px-4 md:px-6">
        <div class="w-full max-w-250 mx-auto space-y-8 md:space-y-10">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <a href="{{ route('custom.index') }}" class="text-butter bg-secondary px-5 py-2 font-bold rounded-2xl inline-block hover:text-secondary hover:bg-butter transition duration-700 shrink-0">Back to Budget</a>
            </div>
            ...
            <form method="POST" action="{{ route('custom.edit') }}" id="customChangeForm" data-custom-budget-form
