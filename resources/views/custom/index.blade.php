    ...
    <main class='py-10 px-6'>
        <div class="w-full max-w-350 mx-auto py-10 flex flex-col justify-center space-y-12">
            <div class='flex justify-between items-center md:space-x-4 space-y-4 w-full'>
                ...
                <div class="flex flex-col items-start space-y-3">
                    <a href="{{ route("custom.change") }}" class="text-butter bg-secondary px-5 py-2 font-bold rounded-2xl inline-block hover:text-secondary hover:bg-butter transition duration-700">Change my Budget</a>
                    <a href="{{ route("custom.history", ["budget" => $budget->id]) }}" class="text-butter bg-secondary px-5 py-2 font-bold rounded-2xl inline-block hover:text-secondary hover:bg-butter transition duration-700">Budget History</a>
                </div>
            </div>
